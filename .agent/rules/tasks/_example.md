---
description: "yy 子任务模板（示例）。复制后改名为你的任务名，并修改 globs。"
alwaysApply: false
globs: tasks/_example/**
---
...
- 对应规则：`.agent/rules/tasks/_example.md`（复制后同步改名）
- **禁止** 修改其他 `tasks/*` 目录及无关全局配置

## 技术约定

技术栈与代码风格见 `.agent/rules/yy-global.md` 和 `.agent/rules/api-patterns.md`，以下仅列模板特有说明：
